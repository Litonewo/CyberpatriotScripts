...
echo -e "\e[0;33mImages deleted, searching for other files. \e[1;m]"

sleep 3

sudo find / -name "*.php" -type f  -delete
sudo find / -name "*.tar.gz" -type f -delete
sudo find / -name "*backdoor*.*" -type f -delete
sudo find / -name "*backdoor*.php" -type f -delete

sleep 3

clear

echo -e "\e[0;33mOther files deleted.\e[1;m]"
...
echo -e "\e[0;33mm Securing the root user...\e[1;m"

echo "\e[0;33mm $LogTime ussL [$UserName] # Securing root...\e[1;m" >> output.log
	PASS='CyberP@triot1234'
	echo -e "$Pass\n$PASS" | passwd root >> output.log
	sudo passwd -l root
echo "\e[0;33mm $LogTime ussL  [$UserName] # Root has been secured.\e[1;m" >> output.log
